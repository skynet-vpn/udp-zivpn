...
```bash
apt update -y && wget -q https://raw.githubusercontent.com/skynet-vpn/udp-zivpn/main/install.sh -O /usr/local/bin/install.sh && chmod +x /usr/local/bin/install.sh && /usr/local/bin/install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/skynet-vpn/udp-zivpn/main/fix-zivpn.sh -O /usr/local/bin/fix-zivpn.sh && chmod +x /usr/local/bin/fix-zivpn.sh && /usr/local/bin/fix-zivpn.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/skynet-vpn/udp-zivpn/main/update.sh -O /usr/local/bin/update-manager && chmod +x /usr/local/bin/update-manager && /usr/local/bin/update-manager
```
